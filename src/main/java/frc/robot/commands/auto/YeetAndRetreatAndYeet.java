...
public class YeetAndRetreatAndYeet extends SequentialCommandGroup {
    ...
    public YeetAndRetreatAndYeet(Drivetrain drivetrain, Shooter shooter, ShooterAdjuster adjuster,
                                 IntakePlacer intakePlacer, IntakeRoller intakeRoller, Storage storage) {
        addCommands(
